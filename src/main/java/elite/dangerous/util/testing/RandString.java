...
import elite.dangerous.util.testing.rng.RandomSource;

public class RandString
{
    private static RestorableUniformRandomProvider provider = RandomSource.JDK.create();
    ...
    {
        return randomAlphabetic(provider.nextInt(minLengthInclusive, maxLengthExclusive));
    }
    ...
    {
        return randomAlphanumeric(provider.nextInt(minLengthInclusive, maxLengthExclusive));
    }
    ...
    {
        return randomAscii(provider.nextInt(minLengthInclusive, maxLengthExclusive));
    }
    ...
    {
        return randomGraph(provider.nextInt(minLengthInclusive, maxLengthExclusive));
    }
    ...
    {
        return randomNumeric(provider.nextInt(minLengthInclusive, maxLengthExclusive));
    }
    ...
    {
        return randomPrint(provider.nextInt(minLengthInclusive, maxLengthExclusive));
    }
}
