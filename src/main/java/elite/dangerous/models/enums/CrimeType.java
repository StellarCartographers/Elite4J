...
public enum CrimeType {
	Assault("Assault"), Murder("Murder"), Piracy("Piracy"), Interdiction("Interdiction"), Illegal_Cargo("IllegalCargo"),
	Disobey_Police("DisobeyPolice"), Fire_In_No_FireZone("FireInNoFireZone"), Fire_In_Station("FireInStation"),
	Dumping_Dangerous("DumpingDangerous"), Dumping_Near_Station("DumpingNearStation"),
	...
	Docking_Minor_Trespass("DockingMinor_Trespass"), Docking_Major_Trespass("DockingMajor_Trespass"),
