...
/**
 * The Enum PlanetClass.
 */
public enum PlanetClass {
	Metal_Rich_Body("Metal rich body"), High_Metal_Content_Body("High metal content body"), Rocky_Body("Rocky body"),
	Icy_Body("Icy body"), Rocky_Ice_Body("Rocky ice body"), Earthlike_Body("Earthlike body"),
	Water_World("Water world"), Ammonia_World("Ammonia world"), Water_Giant("Water giant"),
	Water_Giant_with_Life("Water giant with life"), Gas_Giant_with_Water_based_Life("Gas giant with water based life"),
	...
	Sudarsky_Class_V_Gas_Giant("Sudarsky class V gas giant"), Helium_Rich_Gas_Giant("Helium rich gas giant"),
	...
	/**
     * Gets the planet class identifier.
     *
     * @return the planet class identifier
     */
